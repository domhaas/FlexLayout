...
/******/ 	return __webpack_require__(__webpack_require__.s = "./examples/demo/App.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.loadLayout = function (layoutName, reload) {
        ...
        if (!loaded) {
            Utils_1.default.downloadFile("layouts/" + layoutName + ".layout", this.load.bind(this), this.error.bind(this));
        }
    };
    App.prototype.load = function (jsonText) {
    ...
    App.prototype.allowDrop = function (dragNode, dropInfo) {
    ...
    App.prototype.error = function (reason) {
        alert("Error loading json config file: " + this.loadingLayoutName + "\n" + reason);
    };
    App.prototype.onAddClick = function (event) {
    ...
    App.prototype.onShowLayoutClick = function (event) {
        console.log(JSON.stringify(this.state.model.toJson(), null, "\t"));
    };
    App.prototype.onAdded = function () {
        this.setState({ adding: false });
    };
    App.prototype.onTableClick = function (node, event) {
        console.log("tab: \n" + node._toAttributeString());
        console.log("tabset: \n" + node.getParent()._toAttributeString());
    };
    App.prototype.factory = function (node) {
        ...
        if (component === "grid") {
            ...
            return React.createElement(SimpleTable, { fields: fields, onClick: this.onTableClick.bind(this, node), data: node.getExtraData().data });
        }
    ...
    App.prototype.render = function () {
        ...
        if (this.state.model !== null) {
            contents = React.createElement(FlexLayout.Layout, { ref: "layout", model: this.state.model, factory: this.factory.bind(this), onRenderTab: onRenderTab, onRenderTabSet: onRenderTabSet });
        }
        return React.createElement("div", { className: "app" },
            React.createElement("div", { className: "toolbar" },
                React.createElement("select", { onChange: this.onSelectLayout.bind(this) },
                ...
                React.createElement("button", { onClick: this.onReloadFromFile.bind(this) }, "reload from file"),
                React.createElement("button", { disabled: this.state.adding, style: { float: "right" }, onClick: this.onAddClick.bind(this) }, "Add"),
                React.createElement("button", { style: { float: "right" }, onClick: this.onShowLayoutClick.bind(this) }, "Show Layout JSON in Console"),
                React.createElement("select", { style: { float: "right" }, onChange: this.onThemeChange.bind(this) },
...
var BorderButton = /** @class */ (function (_super) {
    ...
    BorderButton.prototype.render = function () {
        ...
        var content = React.createElement("div", { ref: function (ref) { return _this.contentsRef = (ref === null) ? undefined : ref; }, className: cm("flexlayout__border_button_content") }, renderState.content);
...
var Layout = /** @class */ (function (_super) {
    ...
    /** @hidden @internal */
    Layout.prototype.onModelChange = function (action) {
        this.forceUpdate();
...
var Splitter = /** @class */ (function (_super) {
    ...
    Splitter.prototype.render = function () {
        ...
        return React.createElement("div", { style: style, onTouchStart: this.onMouseDown.bind(this), onMouseDown: this.onMouseDown.bind(this), className: cm("flexlayout__splitter") });
    };
    return Splitter;
}(React.Component));
...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.render = function () {
        ...
        return React.createElement("div", { className: cm("flexlayout__tab"), onMouseDown: this.onMouseDown.bind(this), onTouchStart: this.onMouseDown.bind(this), style: style }, child);
    };
    return Tab;
}(React.Component));
exports.Tab = Tab;
...
var TabButton = /** @class */ (function (_super) {
    ...
    TabButton.prototype.render = function () {
        ...
        if (this.state.editing) {
            ...
            content = React.createElement("input", { style: contentStyle, ref: function (ref) { return _this.contentRef = (ref === null) ? undefined : ref; }, className: cm("flexlayout__tab_button_textbox"), type: "text", autoFocus: true, defaultValue: node.getName(), onKeyDown: this.onTextBoxKeyPress.bind(this), onMouseDown: this.onTextBoxMouseDown.bind(this) });
        }
        var closeButton = undefined;
        if (this.props.node.isEnableClose()) {
            closeButton = React.createElement("div", { className: cm("flexlayout__tab_button_trailing"), 
