...
var TabButton = /** @class */ (function (_super) {
    ...
    TabButton.prototype.onContextMenu = function (event) {
    ...
    TabButton.prototype.onMouseDown = function (event) {
        if (event.button === 2) {
            this.props.layout.doAction(Actions_1.default.selectTab(this.props.node.getId()));
    ...
    TabButton.prototype.bla = function (e) {
        e.preventDefault();
    };
    TabButton.prototype.render = function () {
        ...
        if (this.state.editing) {
            ...
            content = React.createElement("input", { style: contentStyle, ref: function (ref) { return _this.contentRef = (ref === null) ? undefined : ref; }, className: cm("flexlayout__tab_button_textbox"), type: "text", autoFocus: true, defaultValue: node.getName() });
        }
        ...
        return React.createElement("div", { ref: function (ref) { return _this.selfRef = (ref === null) ? undefined : ref; }, style: {
            ...
            //onContextMenu={this.bla.bind(this)}
